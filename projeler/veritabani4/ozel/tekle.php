...
try{
 ...
 if($gad1!="" ){
$query=$conn->exec("insert into altkategori (altkategori_ad) VALUES('$gad1')");
if($query)
            ...
            <i class="fa fa-bars"></i>
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Alt Kategori Ekle</h1>
                    </div>
...
?>
  ...
  <input type="hidden" value="" id="garson_id" name="id">
    ...
    <label for="fname">Alt Kategori</label>
    <input type="text" id="fname" name="gad"  placeholder="Alt Kategori adı">
